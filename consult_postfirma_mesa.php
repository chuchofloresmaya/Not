...
where fech_entrega_proyc_mesa is not null and fech_mesa_postfirma is null
...
?>
    ...
    <tr>
      ...
      <td>
        <?php 
          echo '<button class="alert-success"><a href="exp_pasar_mesa_post.php?id_exp='.$rowfam['id_expediente'].'&user='.$user.'">Entregado a Post-Firma</a></button>';  
        }          
       ?>
       </td>
    </tr>
