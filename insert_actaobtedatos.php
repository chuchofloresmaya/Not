...
switch ($status) {
    case "escritura":
        //echo "-------Escritura---!!!!!!!----";
        //echo "----Type Esc: ".$esc_tipo." Número: ".$no_esc." Type Volumen:---".$vol_tipo." Número vol:---".$no_vol." Check contiene:---".$chbox_contiene_esc." contiene:---".$q_contiene." Check favor:---".$chbox_favor_esc." en favor:---".$e_favor." chbox emitodo:---".$chbox_emitido_esc." emitido:---".$emitido." chbox fecha:---".$chbox_de_fecha_esc." mes:---".$cbx_mes_esc." día:---".$cbx_dia_esc. " año:---".$ano_esc;
...
if ($persona >= 0) {
    ...
    if ($filas_emiti<=0) {
      ...
      if ($chbox_contiene_esc == 1) {
        ...
        $insert_esc_db = "INSERT INTO `not190`.`actas` (`id_cotejo1`, `id_tipo1`, `id_esc_tipo`, `id_esc_vol`, `ac_esc`, `ac_vol`, `a_que_cont`, `id_contenido`, `a_favor`, `id_persona1`, `id_empresa1`, `id_sociedad1`, `id_tipo_emitido1`, `id_emitido1`, `act_fecha`, `a_dia`, `id_mes`, `a_ano`, `usuario4`) VALUES (".$id_cotejo.", '1', ".$id_esc.", ".$id_vol.", '".$no_esc."', '".$no_vol."', ".$chbox_contiene_esc.", ".$id_cont.", ".$chbox_favor_esc.", ".$id_persona.", ".$id_empresa.", ".$id_objetosocial.", ".$chbox_emitido_esc.", ".$id_emiti.", ".$chbox_de_fecha_esc.", ".$cbx_dia_esc.", ".$cbx_mes_esc.", ".$ano_esc.", ".$user.");";
...
//-------------------------------------------------------------------------------------------TARGETA--------------------------------------------------------
    ...
    if ($filas_emiti<=0) {
      ...
      require ("imp_acta_tarjeta.php");
        ...
        echo "-------Targeta de circulación---!!!!!!!----<br>";
        //echo $insert_targeta;
    break;
//-------------------------------------------------------------------------------------------FACTURA--------------------------------------------------------
    case "factura":
    ...
    echo $insert_factura;
      ...
      $result_insert_fac = mysqli_query($con, $insert_factura);
...
//-----------------------------------------------------------------------IDENTIFICACION OFICIAL--------------------------------------------------
    ...
    $insert_identificacion = "INSERT INTO `not190`.`actas` (`id_cotejo1`, `id_tipo1`, `id_persona1`, `id_tipo_emitido1`, `id_emitido1`, `act_fecha`, `a_dia`, `id_mes`, `a_ano`, `ac_idoficial1`, `a_idmex`, `usuario4`) VALUES (".$id_cotejo.", 4, ".$perdona_idof.", ".$chbox_emitido_ido.", ".$id_emiti.", ".$chbox_de_fecha_ido.", ".$cbx_dia_ido.", ".$cbx_mes_ido.", '".$ano_ido."', ".$id_idof.", '".$no_id."', ".$user.");";
        ...
        //echo $insert_identificacion;


      $result_insert_id = mysqli_query($con, $insert_identificacion);
      require ("imp_acta_identificacion.php");



        //echo "<br>-------Identificación oficial---!!!!!!!----";
        //echo "<br>----Type Identificación: ".$id_tipo." Número: >>>".$no_id."<<<< check emitido: ".$chbox_emitido_ido." emitido:---".$emitido_ido." chbox fecha:---".$chbox_de_fecha_ido." mes:---".$cbx_mes_ido." día:---".$cbx_dia_ido. " año:---".$ano_ido ;
...
//-------------------------------------------------------------------------Otro---------------------------------------------------------------------------
  ...
  if (empty($q_contiene_otro)) {
    ...
    $insert_otro = "INSERT INTO `not190`.`actas` (`id_cotejo1`, `id_tipo1`, `a_que_cont`, `id_contenido`, `id_tipo_emitido1`, `id_emitido1`, `act_fecha`, `a_dia`, `id_mes`, `a_ano`, `id_otro`, `a_otro`, `usuario4`) VALUES (".$id_cotejo.", 5, ".$chbox_contiene_otro.", ".$id_cont.", ".$chbox_emitido_otro.", ".$id_emiti.", ".$chbox_de_fecha_otro.", ".$cbx_dia_otro.", ".$cbx_mes_otro.", ".$ano_otro.", ".$id_otro.", '".$otro_doc_vol."', ".$user.");";
      ...
      require ("imp_acta_otro.php");
        ...
        /*echo $insert_otro;
        echo "<br>-------otro documento---!!!!!!!----";
        echo "<br>----Type Documento: ".$otro_doc_tipo." Número: >>>".$otro_doc_vol."<<<< check Contiene: ".$chbox_contiene_otro." que contiene : ".$q_contiene_otro." check emitido: ".$chbox_emitido_otro." emitido:---".$emitido_otro." chbox fecha:---".$chbox_de_fecha_otro." mes:---".$cbx_mes_otro." día:---".$cbx_dia_otro. " año:---".$ano_otro;*/
...
//-------------------------------------------------------------------------MANUAL-------------------------------------------------
    ...
    $insert_manual = "INSERT INTO `not190`.`actas` (`id_cotejo1`, `id_tipo1`, `id_tipo_emitido1`, `id_emitido1`, `act_fecha`, `a_dia`, `id_mes`, `a_ano`, `ac_manual`, `usuario4`) VALUES (".$id_cotejo.", '6', ".$id_tipo_emitido.", ".$id_emiti.", ".$id_fecha_man.", ".$cbx_dia_manual.", ".$cbx_mes_manual.", ".$ano_manual.", '".$id_corresponde."', ".$user.");";
      ...
      $result_insert_otro = mysqli_query($con, $insert_manual);
