...
<div id="productos">
  <?php require_once("comparecientes.php") //<-------------------------------------------compadecientes div-----------------------------------------;?>
</div>
<div id="row">
...
//PARA LOS COMPADECIENTES-------------------------------------------------------------------------------------------------------------------------
  ...
  if(!empty($_POST["guardar"])) {
    ...
    $contador = count($_POST["nombre_com"]);
    $ProContador=0;
    $query = "INSERT INTO `not190`.`compareciente` (`id_exp`, `id_tipo_compareciente`, `nombre_com`, `fecha_nacimeinto`, `lugar_nacimiento`, `estado_civil`, `nombre_conyuge`, `domicilio`, `ocupacion`, `curp`, `rfc`, `doc_identificacion`, `no_identificacion`, `id_usu`) VALUES ";
    $queryValue = "";
    for($i=0;$i<$contador;$i++) {
      if(!empty($_POST["nombre_com"][$i])) {
        ...
        $queryValue .= "('" . $no_exp . "', '" . $_POST["id_tipo_compareciente"][$i] . "', '" . 1 . "', '" . $_POST["fecha_nacimeinto"][$i] . "', '" . $_POST["lugar_nacimiento"][$i] . "', '" . 1 . "', '" . 2 . "', '" . $_POST["domicilio"][$i] . "', '" . $_POST["ocupacion"][$i] . "', '" . $_POST["curp"][$i] . "', '" . $_POST["rfc"][$i] . "', '" . $_POST["doc_identificacion"][$i] . "', '" . $_POST["no_identificacion"][$i] . "', '" . 1 . "')";
      }
    }
