...
<center><h1 class="display-3">Expedientes</h1></center>
  ...
  <thead>
    ...
    <tr>
      ...
      <th class="col-1">Acto</th>
      <th class="col-1">Fechas</th>
...
clave_valor, no_adeudo_predial, no_adeudo_agua, zonificacion, tradi_acto.actos as tradi_acto1, tradi_institu.institucion as tradi_institu1, observaciones_2, clg_tradi_tramite, clg_tradi_termino, cert_entrega_gestor, cert_entrega_municipio, cert_por_gestor, observaciones_3,entrega_al_proyectista FROM not190.expediente 
...
where fech_entrega_prev_mesa is not null and entrega_al_proyectista is null
...
?>
    ...
    <tr>
      ...
      <td>CLG: <b><?php if($rowfam['clg_tipo'] >= 1){ echo $rowfam['clg_tipo'];}else{echo "PENDIENTE";} ?></b><br>
      ...
      <td>Fecha entrega a gestor: <br><?php echo $rowfam['cert_entrega_gestor'] ?><br>
          Fecha entrega entrega al municipio: <br> <?php echo $rowfam['cert_entrega_municipio'] ?><br>
          Fecha entrega por el gestor: <br><?php echo $rowfam['cert_por_gestor'] ?><br>
      </td>  
      <td>Observaciones Ingreso <?php echo $rowfam['observaciones_1'] ?> <br>Observaciones de previa: <?php echo $rowfam['observaciones_2'] ?><br>Observaciones de fechas: <?php echo $rowfam['observaciones_3'] ?></td>
      <td><?php       
          echo '<button class="alert-success"><a href="entregas_exp.php?id_exp='.$rowfam['id_expediente'].'">INGRESAR ENTREGAS</a></button>';
       ?>
        <?php if ($rowfam['cert_por_gestor'] > 1) {
          echo '<button class="alert-success"><a href="exp_pasar_proyectista.php?id_exp='.$rowfam['id_expediente'].'&user='.$user.'">Entregado a Proyectista</a></button>';  
          echo "<br>Proyectista: ".$rowfam['proyectista'];
        }          
       ?>
       </td>
    </tr>
