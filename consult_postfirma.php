...
where fech_mesa_postfirma is not null 
...
?>
    ...
    <tr>
      ...
      <td>
        <?php 
          echo '<button class="alert-success"><a href="insert_traslado.php?id_exp='.$rowfam['id_expediente'].'&user='.$user.'">Traslado</a></button>';
          echo '<br><br><br><br><br><button class="alert-success"><a href="exp_pasar_proyectista.php?id_exp='.$rowfam['id_expediente'].'&user='.$user.'">Entregado a Mesa</a></button>';  
        }          
       ?>
       </td>
    </tr>
