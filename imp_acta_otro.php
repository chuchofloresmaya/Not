<?PHP
    ...
    $queryacta_fac = "SELECT id_acta ,id_cotejo1, id_tipo1, tipo_que_contiene, ac_contenido, tipo_emitido, emitido, de_fecha, a_dia, mes, a_ano, tipo_otros, a_otro, usuario4 FROM not190.actas 
    ...
    $ca_tipo_cont = $row_act_esc_g['tipo_que_contiene'];
    $ca_cont = $row_act_esc_g['ac_contenido'];
    ...
    $ca_a_otro = $row_act_esc_g['a_otro'];
    ...
    $ca_esc_contenido = $ca_tipo_otro." ".$ca_a_otro." ".$ca_tipo_cont." ".$ca_cont;
