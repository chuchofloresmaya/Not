<?PHP
	...
	$templateProcessor=new \PhpOffice\PhpWord\TemplateProcessor('plantillas/cer_predial_mejoras.docx');
...
/*	echo "
	...
	$templateProcessor->setValue('ubicacion_vivienda', $ubicacion_inmueble);
	...
	header('Content-Disposition: attachment; filename="'.$no_exp.'-predial_mejoras.docx"');
