<?PHP
	...
	$con= conectar();
      ...
      //de letras a numeros 
		...
		//require ("certificacion_cotejo.php");
		//header('location: certificacion_cotejo.php?i_h_anexa=2&l_no_fojas=9&lado&mostrada=1&l_tantos=1&solicitud=2&l_no_cotejo=1&l_libro=1&n_libro=1&n_cotejo=1');
		header('location: certificacion_cotejo-oficio.php?i_h_anexa='.$i_hoja_anexa.'&i_n_fojas='.$l_no_fojas.'&i_copia='.$copia_c.'&i_h_lados='.$lado.'&i_h_mostrada='.$mostrada.'&i_h_tantos='.$l_tantos.'&i_s_solicitud='.$solicitud.'&i_h_lcotejo='.$l_no_cotejo.'&i_h_llibro='.$l_libro.'&i_h_lfecha='.$l_fecha.'&i_no_cotejo='.$no_cotejo.'&i_no_libro='.$libro);
