...
<div class="row">
  ...
  <div class="col-xs-6 col-md-3" id="">Ubicacion de vivienda (en Mayusculas):
      <textarea rows="6" cols="60" name="ubicacion_vivienda" form="formulario_sec"><?php echo $fila_exp['ubicacion_inmueble'] ?></textarea>
  </div>
    <div class="col-xs-6 col-md-2" id="">Folio Real electronicos:
...
<div class="row">
  <div class="col-xs-6 col-md-1 "></div>
    <div class="col-xs-6 col-md-3" id="propietario" style="display:none;">Propietario:
    ...
    <div class="col-xs-6 col-md-3" id="comprador" style="display:none;">Clave Catastral:<br>
      <input class="form-control" type="text" id="clave_catastral" name="clave_catastral" value="<?php echo $fila_exp['clave_catastral'] ?>">
  </div>
    <div class="col-xs-6 col-md-2" id="institucion" style="display:none;">Institución:
...
<div class="row">
  <div class="col-xs-6 col-md-1 "></div>
    <div class="col-xs-6 col-md-4" id="medidas_colindancias" style="display:none;">Medidas y conlindancias:
      <textarea rows="6" cols="80" name="medidas_colindancias2" form="formulario_sec"><?php echo $fila_exp['medidas_colindancias'] ?></textarea>
  </div>
<div class="col-xs-6 col-md-2" id="fecha_tramite" style="display:none;"><br>Fecha de ingreso:
   <input class="form-control" type="date" id="clg_fecha_tramite" name="clg_fecha_tramite" value="<?php echo $fila_exp['clg_tradi_tramite'] ?>">
    <br>
  </div>
<div class="col-xs-6 col-md-2" id="fecha_termino" style="display:none;"><br>Fecha de egreso:
  ...
  <script>
    function titulo_p(dato){
        if(dato=='SI'){
            ...
            document.getElementById("folio_real").style.display = "block";
            ...
            document.getElementById("medidas_colindancias").style.display = "block";
            document.getElementById("fecha_tramite").style.display = "block";
            document.getElementById("fecha_termino").style.display = "block";                        
        ...
        if(dato=='NO'){
            ...
            document.getElementById("folio_real").style.display = "none";
            ...
            document.getElementById("medidas_colindancias").style.display = "none";
            document.getElementById("fecha_tramite").style.display = "none";
            document.getElementById("fecha_termino").style.display = "none";              
...
if(isset($_POST['regfam'])){
   ...
   if ($clave_valor < 1) {
    ...
    /*
    echo "<br> no_exp: ".$no_exp;
    echo "<br> TIPO de CLG: ".$tipo_clg;
    echo "<br> Select oficina: ".$select_oficina;
    echo "<br> Ubicacion de la vivienda: ".$ubicacion_vivienda;
    echo "<br> Folio real Clg tradicional: ".$folio_real;
    echo "<br> Propietario de la vivienda: ".$propietario;
    echo "<br> acto: ".$acto;
    echo "<br> Institucion: ".$institucion;
    echo "<br> Comprador: ".$comprador;
    echo "<br> Medidas y colindancias atras: ".$medidas_colindancias;
    echo "<br> clg fecha de tramite: ".$clg_fecha_tramite;
    echo "<br> clg fecha de termino: ".$clg_fecha_termino;
    echo "<br> CLG folio real automatizdo: ".$auto_folio_real;
    echo "<br> Clave valor: ".$clave_valor;
    echo "<br> No adeudo predial: ".$no_adeudo_predial;
    echo "<br> No adeudo agua: ".$no_adeudo_agua;
    echo "<br> zonificacion: ".$zonificacion;
    echo "<br> Obsercaciones de la previa: ".$observaciones_previa;*/
  ...
  if ($tipo_clg == "SI") {
    ...
    if ($filas_comp<=0) {
      ...
      $insert_clg = "INSERT INTO `not190`.`clg_tradicional` (`id_oficina`, `ubicacion_inmueble`, `folio_real`, `id_propietario`, `id_acto`, `id_comprador`, `id_institucion_clg_tradi`, `medidas_colindancias`, `insercion_fecha_hora`, `usuario_insert_clg`) VALUES (".$select_oficina.", '".$ubicacion_vivienda."', '".$folio_real."', ".$id_propietario.", ".$acto.", ".$id_comprador.", ".$institucion.", '".$medidas_colindancias."', '".$date->format("Y-m-d H:i:s")."', ".$user.");";
      //echo $insert_clg;
      ...
      //echo "insert: ---> ".$insert_exp_previa;
          ...
          $insert_expdiente = "UPDATE `not190`.`expediente` SET `id_clg` = '2', `clg_auto_folio_real` = '".$auto_folio_real."', `clave_valor` = ".$clave_valor.", `no_adeudo_predial` = ".$no_adeudo_predial.", `no_adeudo_agua` = ".$no_adeudo_agua.", `zonificacion` = ".$zonificacion.",`observaciones_2` = '".$observaciones_previa."', `fecha_insert_clg` = '".$date->format("Y-m-d H:i:s")."', `id_usuario_clg_certis` = ".$user." WHERE (`id_expediente` = ".$no_exp.");";
      //echo $insert_expdiente;
      $result_insert_expediente = mysqli_query($con, $insert_expdiente);
  }else{
        $insert_expdiente_pend = "UPDATE `not190`.`expediente` SET `clg_auto_folio_real` = '".$auto_folio_real."', `clave_valor` = ".$clave_valor.", `no_adeudo_predial` = ".$no_adeudo_predial.", `no_adeudo_agua` = ".$no_adeudo_agua.", `zonificacion` = ".$zonificacion.",`observaciones_2` = '".$observaciones_previa."', `fecha_insert_clg` = '".$date->format("Y-m-d H:i:s")."', `id_usuario_clg_certis` = ".$user." WHERE (`id_expediente` = ".$no_exp.");";
      //echo $insert_expdiente;
...
?>
    ...
    <tr>
      ...
      <?php 
          if ($rowfam['tradi_clg_id'] == 1) {
            echo '<button class="alert-success"><a href="CLG.php?id_clg='.$rowfam['id_clg_tradicional'].'">CLG word</a></button>';
          } ?>
      </td>      
    </tr>
<?PHP
