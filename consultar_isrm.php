...
?>
            ...
            <tr>
              ...
              <th><?php echo $rowfam['u_nombre'] ?></th>
...
?>
            <tr>
              ...
              <td><?php echo "<a href='modificar_isr.php?idfam=".$rowfam['id_isr']."'><button type='button'>Modificar</button></a>" ?></td>
...
?>
        ...
        <nav aria-label="...">
          <ul class="pagination ">
            ...
            ?>
            <li class="page-item">
              <a class="page-link text-dark" href="consultar_isrm.php?pag=<?PHP echo $_GET['pag']-1 ?>">Anterior</a>
            </li>
            <?PHP 
            } 
            ...
            <li class="page-item">
                <a class="page-link text-dark" href="consultar_isrm.php?pag=<?PHP echo $i ?>"><?PHP echo $i ?></a>
            </li>
            <?PHP
            }}
            ...
            <li class="page-item">
              <a class="page-link text-dark" href="consultar_isrm.php?pag=<?PHP echo $_GET['pag']+1 ?>">Siguiente</a>
            </li>
            <?PHP
                }
            ?>            
