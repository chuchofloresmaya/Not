<?PHP
    ...
    $queryacta_fac = "SELECT id_acta ,id_cotejo1, id_tipo1, tipo_emitido, emitido, de_fecha, a_dia, mes, a_ano, tipo_identificacion, a_idmex, usuario4 FROM not190.actas 
    ...
    $ca_tipo_ident = $row_act_esc_g['tipo_identificacion'];
    $ca_no_ident = $row_act_esc_g['a_idmex'];
    ...
    $ca_esc_contenido = $ca_tipo_ident." ".$ca_no_ident;
