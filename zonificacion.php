<?PHP
	...
	$templateProcessor=new \PhpOffice\PhpWord\TemplateProcessor('plantillas/cer_zonificacion.docx');
...
/*	echo "
	...
	header('Content-Disposition: attachment; filename="'.$no_exp.'-zonificación.docx"');
